...
Littérature : Coordinatization of join-distributive lattices, Gábor Czédli
...
\begin{theo}
   ...
   \item \label{item:6} $\L$ est isomorphe au treillis des ouverts d'une clôture d'antiéchange (ou antimatroïde).
   \end{enumerate}
\end{theo}
...
Citer AN EXTENSION OF BIRKHOFF’S REPRESENTATION THEOREM TO INFINITE DISTRIBUTIVE LATTICES
DALE R. WORLEY
